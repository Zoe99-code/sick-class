...
MSickID = Label(window, text = "Sickness Code")
...
MDurationOfTreatment = Label(window, text = "Duration Of Treatment")
...
MDoctorsID = Label(window, text="Doctors Practice Number")
